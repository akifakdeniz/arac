...
?>
        <div class="box" >
            ...
            <div class="box-header with-border">
                <span><i class="fa fa-cog"></i> Onaylananlar
            </div>
            ...
            <div class="box-body">
                ...
                <table class="table table-striped">
                    ...
                    $posts = Db::getAll('tbl_gorev','WHERE durum = ? AND onay = ? AND A_Onay = ? AND S_Onay = ? ORDER BY ID DESC,onay ASC',array(1,1,1,1));
                    ...
                    ?>
                        <tr>
                            <td ><span class="btn btn-xs btn-success"> <i class="fa fa-check"></i> </span></td>
                            <td ><?=$post->ID;?></td>
