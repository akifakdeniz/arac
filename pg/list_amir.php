...
<div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Amir Liste</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        <div class="box-header">
          ...
          <?php
		  $count = Db::count('tbl_amir','WHERE durum = ? ORDER BY ID DESC',array(1));
		  ?>
        ...
        <table class="table table-striped">
            ...
            <tr>
              <th style="width: 5%">#</th>
              <th style="width: 55%">Adı Soyadı</th>
              <th style="width: 30%">Ünvan</th>
              <th style="width: 10%; text-align:center" colspan="2">İşlem</th>
            </tr>
            <?php
            $i=1;
            $posts = Db::getAll('tbl_amir','WHERE durum = ? ORDER BY ID DESC',array(1));
