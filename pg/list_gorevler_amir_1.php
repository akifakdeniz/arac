...
?>
        ...
        <div class="box" >
            ...
            <div class="box-header with-border">
                <span><i class="fa fa-cog"></i> Görevler Sayısı
                <span>: <?=amirsor('tbl_gorev',1,1,$_SESSION['Sube'],0,0,0);?></span></span>&nbsp;&nbsp; 
            </div>
            ...
            <div class="box-body">
                ...
                <table class="table table-striped">
                    ...
                    $posts = Db::getAll('tbl_gorev','WHERE durum = ? AND onay = ? AND A_Onay = ? ORDER BY ID DESC,onay ASC',array(1,1,0));
