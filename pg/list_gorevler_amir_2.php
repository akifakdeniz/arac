<?php
	...
	$durum 	= Db::count('tbl_gorev','WHERE durum = ? AND onay = ? AND A_Onay = ?',array(1,1,1));
?>
        <div class="box" >
            <div class="box box-solid">
            <div class="box-header with-border">
                <span><i class="fa fa-cog"></i> Onaylanan Görev Sayısı
                <span>: <?=amirsor('tbl_gorev',1,1,$_SESSION['Sube'],1,0,0);?></span></span>&nbsp;&nbsp; 
            </div>
            ...
            <div class="box-body">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <th style="width: 15%">Görev Yeri</th>
                    ...
                    $posts = Db::getAll('tbl_gorev','WHERE durum = ? AND onay = ? AND A_Onay = ? ORDER BY ID DESC,onay ASC',array(1,1,1));
                    foreach ($posts as $post) {
				    ?>
                        <tr>
                            <td ><span class="btn btn-xs btn-success"> <i class="fa fa-check"></i> Onaylandı</span></td>
                            <td ><?=$post->ID;?></td>
