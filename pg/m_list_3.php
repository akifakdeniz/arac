...
?>
		<div class="box ">
            <div class="box-header with-border">
              <h3 class="box-title">Sevk Amir Onay Bekleyen</h3>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    ...
                    <?php
                    $posts = Db::getAll('tbl_gorev','WHERE durum = ? AND onay = ? AND amirID = ? AND A_Onay = ? AND S_Onay = ?  ORDER BY ID DESC,onay ASC',
					array(1,1,$_SESSION['Sube'],1,0));
